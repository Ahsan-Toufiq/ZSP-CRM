...
function CustomersPanel({ customers, ledgerByCustomer, expanded, canWrite, onToggle, onAdd, onEdit, onDelete, onStatus }: { customers: Customer[]; ledgerByCustomer: Map<UUID, CustomerLedgerEntry[]>; expanded: Set<UUID>; canWrite: boolean; onToggle: (id: UUID) => void; onAdd: () => void; onEdit: (customer: Customer) => void; onDelete: (customer: Customer) => void; onStatus: (customer: Customer) => void }) {
